...
#endif
#ifdef WS2815
    PWM_HI = (u8_t) (APBfq * 0.8) - 1;
    PWM_LO = (u8_t) (APBfq * 0.2) - 1;
#endif
...
#if defined(SK6812) || defined(WS2811F) || defined(WS2811S) || defined(WS2815)
    const u8_t subp1 = r;
    const u8_t subp2 = g;
    const u8_t subp3 = b;
#else
...
// Check strip type
#if !(defined(SK6812) || defined(WS2811F) || defined(WS2811S) || defined(WS2812) || defined(WS2815))
